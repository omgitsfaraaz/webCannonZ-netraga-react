...
!(function (e) {
  ...
  (NETRAGA.headerSpacer = {
    ...
    (NETRAGA.updateResponsiveInit = function () {
      var i = null,
        t = function () {
          (i = null), NETRAGA.headerSpacer.resize();
        };
      e(window)
        .on("resize", function () {
          null === i &&
  ...
  (NETRAGA.fixedHeader = function () {
    ...
    (NETRAGA.equalHeight = function () {
      e(".js-equal-child")
        .find(".theme-module")
        .matchHeight({ property: "min-height" });
    }),
    (NETRAGA.SubscribeScrollAnnimation = function () {
    ...
    (NETRAGA.SeoScoreScrollAnnimation = function () {
      var e = new ScrollMagic.Controller();
    ...
    (NETRAGA.TestimonialScrollAnnimation = function () {
      var e = new ScrollMagic.Controller();
    ...
    (NETRAGA.OurVisionScrollAnnimation = function () {
      var e = new ScrollMagic.Controller();
    ...
    (NETRAGA.MountainsScrollAnnimation = function () {
      var e = new ScrollMagic.Controller();
    ...
    (NETRAGA.burgerAnimation = function () {
      function e(e) {
    ...
    i.keydown(function (e) {
      27 == e.which &&
        (d.hasClass("opened") && NETRAGA.togglePanel(),
        o.hasClass("open") && NETRAGA.toggleSearch());
    }),
    ...
    jQuery(".js-close-aside").on("click", function () {
      return d.hasClass("opened") && NETRAGA.togglePanel(), !1;
    }),
    jQuery(".js-open-aside").on("click", function () {
      return d.hasClass("opened") || NETRAGA.togglePanel(), !1;
    }),
    jQuery(".js-open-search").on("click", function () {
      return NETRAGA.toggleSearch(), !1;
    }),
    ...
    (NETRAGA.maps = {
      maps: {
        mapUSA: {
          ...
          markers: [{ coords: [38.897663, -77.036575] }],
        },
      },
      init: function () {
    ...
    t.ready(function () {
      e("#menu-icon-wrapper").length && NETRAGA.burgerAnimation(),
        d.length && NETRAGA.customScroll(),
        u.crumegamenu({
          showSpeed: 0,
          hideSpeed: 0,
          trigger: "hover",
        ...
        NETRAGA.mediaPopups(),
        NETRAGA.IsotopeSort(),
        NETRAGA.parallaxFooter(),
        NETRAGA.rangeSlider(),
        NETRAGA.headerSpacer.init(),
        NETRAGA.updateResponsiveInit(),
        NETRAGA.maps.init(),
        e("select").niceSelect(),
        FastClick.attach(document.body),
        "function" == typeof SmoothScroll &&
          (NETRAGA.smoothScroll = new SmoothScroll('a[href*="#"]', {
            header: "#site-header",
          })),
        NETRAGA.animateSvg(),
        NETRAGA.counters(),
        NETRAGA.progresBars(),
        NETRAGA.pieCharts(),
        e(".subscribe").length && NETRAGA.SubscribeScrollAnnimation(),
        e(".seo-score").length && NETRAGA.SeoScoreScrollAnnimation(),
        e(".testimonial-slider").length &&
          NETRAGA.TestimonialScrollAnnimation(),
        e(".our-vision").length && NETRAGA.OurVisionScrollAnnimation(),
        e(".background-mountains").length &&
          NETRAGA.MountainsScrollAnnimation();
    });
})(jQuery);
