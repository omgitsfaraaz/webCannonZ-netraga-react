/*!VelocityJS.org (1.2.3). (C) 2014 Julian Shapiro. MIT @license: en.wikipedia.org/wiki/MIT_License*/ /*!VelocityJS.org jQuery Shim (1.0.1). (C) 2014 The jQuery Foundation. MIT @license: en.wikipedia.org/wiki/MIT_License.*/ (function (
  window
) {
  if (window.jQuery) {
    return;
              ...
              function calculateUnitRatios() {
                ...
                if (callUnitConversionData.vwToPx === null) {
                  ...
                  callUnitConversionData.vhToPx =
                    parseFloat(window.innerHeight) / 100;
                }
